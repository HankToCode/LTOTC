 ...
 */
open class BaseViewModel<M : BaseModel?> @JvmOverloads constructor(application: Application, protected var model: M? = null) : AndroidViewModel(application), IBaseViewModel, Consumer<Disposable?> {
