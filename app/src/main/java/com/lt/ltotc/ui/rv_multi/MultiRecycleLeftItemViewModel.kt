 ...
 * Description：
 */
class MultiRecycleLeftItemViewModel(viewModel: MultiRecycleViewModel, text: String) : MultiItemViewModel<BaseViewModel<BaseModel>?>(viewModel as BaseViewModel<BaseModel>) {
    @JvmField
